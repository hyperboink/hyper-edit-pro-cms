...
<form action="<?=base_url()?>form/update/<?=$form->id?>" method="POST">

	<input type="hidden" name="id" value="<?=$form->id?>">
	<input type="hidden" name="shortcode_form_id" class="form-shortcode-id-data" value="<?=$form->shortcode_form_id?>">
	<input type="hidden" name="shortcode_form_key" class="form-shortcode-key-data" value="<?=$form->shortcode_form_key?>">
	<input type="hidden" name="name" class="form-name-data">
	<input type="hidden" name="shortcode" class="form-shortcode-data" value="form_<?=$form->shortcode_form_key?><?=$form->shortcode_form_id?>">

	<div class="form-top px-3 py-4 row">
		<div class="col-md-9">
			<div id="content_form_name" class="form-title-wrap mb-2" data-field>
				<h3 class="form-title-tab form-label"><?=$form->name?></h3>
				<span class="form-hint">| click to edit</span>
			</div>

			<div class="form-shortcode" data-shortcode="<?=$form->shortcode?>">
				{form_<span><?=$form->shortcode_form_key?></span><?=$form->shortcode_form_id?>}
			</div>
		</div>

		<div class="col-md-3 text-right mt-3">
			<a class="btn btn-secondary" href="<?=base_url()?>form/create" class=""><i class="fa fa-plus" aria-hidden="true"></i> Create</a>
			<a class="btn btn-info" href="<?=base_url()?>form/settings/<?=$form->id?>" class=""><i class="fa fa-cog" aria-hidden="true"></i> Settings</a>
		</div>
	</div>

	<?php if(isset($message)):?>
		<div class="mt-3 mx-4 mb-0 alert alert-<?=$message['status']?> alert-dismissible fade show" role="alert">
			<?=$message['text']?>
							...
							<div id="components-container" class="form-horizontal">
								...
								<div class="component-box">
									...
									<div class="component form-group" data-type="textarea" data-field>
										...
										<div class="controls">
											<textarea class="form-control form-text" rows="4" placeholder="placeholder"></textarea>
										</div>
						...
						<div class="tab-content">
							<div class="tab-pane active" id="editor-tab">
								...
								<div class="text-center mb-3">
									Click / Drag Components here.
								</div>

								<div id="content" class="form-horizontal py-4">
									
									<?php foreach($fields as $key => $field):?>

										<?php if($field['type'] == 'text'):?>
											<div class="form-group ui-draggable element" data-type="text" data-field>
												<div class="close">×</div>
												...
												<div class="controls">
													<input type="text" placeholder="<?=$field['placeholder']?>" class="form-control form-text">
												</div>

												<input type="hidden" name="form_component[]" class="form-field-data" value='<?=$field['object']?>'>
											</div>
										<?php endif?>

										<?php if($field['type'] == 'textarea'):?>
											<div class="form-group ui-draggable element" data-type="textarea" data-field>
												<div class="close">×</div>
												...
												<div class="controls">
													<textarea name="textarea_input" class="form-control" rows="4" placeholder="<?=$field['placeholder']?>"></textarea>
												</div>
										...
										<?php if($field['type'] == 'select_basic'):?>
											<div class="form-group ui-draggable element" data-type="select_basic" data-field>
												<div class="close">×</div>

												<label class="control-label form-label" for="select_basic"><?=$field['label']?></label>

												<div class="controls">
													<select name="basic_multiple" class="select_basic form-control">
										...
										<?php if($field['type'] == 'checkbox'):?>
											<div class="form-group ui-draggable element" data-type="<?=$field['type']?>" data-field>
												<div class="close">×</div>

												<label class="control-label form-label"><?=$field['label']?></label>
												...
												<div class="controls">
													...
													<?php foreach($field['options'] as $option_key => $option):?>
														...
														<div class="checkbox">
															<label>
																<input type="checkbox" name="checkbox" value="<?=$option['value'];?>"> <?=$option['text'];?>
															</label>
														</div>
										...
										<?php if($field['type'] == 'radio'):?>
											<div class="form-group ui-draggable element" data-type="radio" data-field>
												<div class="close">×</div>
												...
												<div class="controls">
													<?php foreach($field['options'] as $option_key => $option):?>
														...
														<div class="radio">
															<label>
																<input type="radio" name="radio" value="<?=$option['value'];?>"> <?=$option['text'];?>
															</label>
														</div>
										...
										<?php if($field['type'] == 'file'):?>
											<div class="form-group ui-draggable element" data-type="file" data-field>
												<div class="close">×</div>
										...
										<?php if($field['type'] == 'static_text'):?>
											<div class="form-group ui-draggable element" data-type="static_text" data-field>

												<div class="close">×</div>

												<label class="control-label form-label"><?=$field['label']?></label>

												<div class="controls form-value"><?=$field['value']?></div>
					...
					<div class="sticky-top save-page-wrap">
						<div class="card">
							<div class="card-body">
								...
								<h4 class="text-center">Update changes?</h4>

								<div class="form-group mt-4 mb-1">
									<div class="custom-control custom-checkbox">
										<input type="checkbox" class="custom-control-input" id="form-label-setting" name="label_hidden" <?=$form->label_hidden ? 'checked' : ''?>>
								...
								<div class="form-group mt-1 mb-4">
									<div class="custom-control custom-checkbox">
										<input type="checkbox" class="custom-control-input" id="form-placeholder-setting" name="placeholder_hidden" <?=$form->placeholder_hidden ? 'checked' : ''?>>
										<label class="custom-control-label" for="form-placeholder-setting">Hide Placeholders</label>
									</div>
								</div>

								<button type="submit" class="btn btn-info btn-block"><i class="fa fa-floppy-o" aria-hidden="true"></i> Update</button>
							</div>
						</div>
					</div>
				</div>
