<form action="<?=base_url()?>template/update/<?=$id?>" class="page-edit" method="POST" enctype="multipart/form-data" method="post" accept-charset="utf-8">

	<div class="form-top px-4 py-4 row mb-4">
		<!-- <div class="col-md-1"><h3><i class="fa fa-file-o mr-2" aria-hidden="true"></i></h3></div> -->
		<div class="col-md-9 pl-0">
			<div class="mb-0 position-relative">
				<i class="fa fa-file-o mr-2 position-absolute" aria-hidden="true"></i>
				<input type="text" name="title_alias" class="form-control form-control-lg page-title-input" placeholder="Page title here..." value="<?=$title_alias ?: $title?>">
			</div>
								...
								<?php if($data['type'] == 'image'):?>
									...
									<div class="form-group">
										...
										<div class="row input-file-con">
											...
											<input type="hidden" name="<?=$key?>_current_image" class="form-control current-image" data-image="<?=$data['value']['name'].$data['value']['ext']?>">
										</div>
